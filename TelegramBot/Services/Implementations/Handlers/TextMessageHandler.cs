            ...
            switch (text.ToLower())
            {
                ...
                case "/info":
                    var info = new StringBuilder()
                        ...
                        .AppendLine()
                        .AppendLine("1️⃣ Оформлення полісу:** Я допоможу вам швидко оформити страховий поліс, вам тільки треба надіслати фото документів.")
                        .AppendLine("2️⃣ Консультація:** Я можу відповісти на ваші питання щодо страхування в Україні.")
